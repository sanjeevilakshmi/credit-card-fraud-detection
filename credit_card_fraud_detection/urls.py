...
from credit_card_fraud_detection import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Credit_Card_Fraud_Detection/$', remoteuser.Predict_Credit_Card_Fraud_Detection, name="Predict_Credit_Card_Fraud_Detection"),
    ...
    url(r'^View_CC_Fraud_Detection_Ratio/$', serviceprovider.View_CC_Fraud_Detection_Ratio, name="View_CC_Fraud_Detection_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_CC_Fraud_Detection/$', serviceprovider.View_Prediction_Of_CC_Fraud_Detection, name="View_Prediction_Of_CC_Fraud_Detection"),
